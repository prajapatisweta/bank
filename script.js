...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    // API implementation for date and time
    const now = new Date();
    const options = {
      hour: "numeric",
      minute: "numeric",
...
console.log(Number.isFinite("20.6")); // false
console.log("------");
...
const days1 = calcDaysPassed(new Date(2023, 4, 10), new Date(2024, 4, 17));
console.log(days1);

// Settimeout function
const ing = ["onion", "mushroom", "capsicum"];
...
// if(ing.includes('mushroom')) clearTimeout(pizzaTimer);
